...
2. **Setup:** Does `memoria-solo setup` create `~/.memoria-solo/` and init SQLite?
...
5. **Search:** Does `memoria-solo search "test query"` return relevant results?
...
[FAIL] 2. Setup — ~/.memoria-solo not created (error: ...)
